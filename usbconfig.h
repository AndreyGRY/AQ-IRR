 ...
 */
#define USB_CFG_INTR_POLL_INTERVAL      30
 ...
 */
#define USB_CFG_IMPLEMENT_FN_WRITE      0//1?
 ...
 */
#define USB_CFG_VENDOR_NAME     'A', 'Q', 'U', 'A', 'R', 'I', 'U', 'S'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'A', 'Q', 'Q', '_', 'I', 'R', 'R', '-', '1', ' '
...
#define USB_CFG_INTERFACE_SUBCLASS  1   //	test	/*  boot interface & SOF*/
#define USB_COUNT_SOF               1
#define USB_CFG_INTERFACE_PROTOCOL  0   /* no protocol */
/* See USB specification if you want to conform to an existing device class or
 * protocol.
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH 76	// Modified Report Descriptor, 78 xbox, 98 leo, 70 test, 72 work, 76b gyver
